...
ginmappeR:::testEquals(getKEGG2UniProt('aag:5579347'), c('Q1DGP2','A0A1S4G4Z1'))
ginmappeR:::testEquals(getKEGG2UniProt(c('aag:5579347','aag:5579347')), list(c('Q1DGP2','A0A1S4G4Z1'),c('Q1DGP2','A0A1S4G4Z1')))
# No translation case
ginmappeR:::testEquals(getKEGG2UniProt('eco:b0204'), character(0))
# ID not valid case
ginmappeR:::testEquals(getKEGG2UniProt('test'), NULL)
...
ginmappeR:::testEquals(getKEGG2NCBINucleotide(c('llo:LLO_2673','llo:LLO_2673'), bySimilarGenes = TRUE), list(c('NC_013861.1'),c('NC_013861.1')))
...
ginmappeR:::testEquals(getKEGG2NCBIGene(c('aag:5579347','aag:5579347'), bySimilarGenes = TRUE), list(c('5579347'),c('5579347')))
# ID not valid case
ginmappeR:::testEquals(getKEGG2NCBIProtein('test'), NULL)
ginmappeR:::testEquals(getKEGG2NCBINucleotide('test'), NULL)
ginmappeR:::testEquals(getKEGG2NCBIGene('test'), NULL)
...
ginmappeR:::testEquals(getKEGG2CARD(c('ag:ACC85616','ag:ACC85616')), list(c("ARO:3002804"),c("ARO:3002804")))
...
# No translation case
ginmappeR:::testEquals(getKEGG2CARD('llo:LLO_2673', exhaustiveMapping = TRUE, detailedMapping = TRUE, bySimilarGenes = FALSE), list())
# ID not valid case
ginmappeR:::testEquals(getKEGG2CARD('test'), NULL)
